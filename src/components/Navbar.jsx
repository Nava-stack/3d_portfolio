      ...
      <div className="w-full flex justify-between items-center max-w-7xl mx-auto">
        ...
        >
          ...
          <p className="text-white text-[18px] font-bold flex cursor-pointer">
            {" "}
            Navarasan &nbsp;
            <span className="sm:block hidden">Thirunavukkarasu</span>
          </p>
        </Link>
        ...
        <div className="sm:hidden flex flex-1 justify-end items-center">
          ...
          <div
            className={`${
              !toggle ? "hidden" : "flex"
            } p-6 black-gradient top-20 absolute right-0 mx-4 my-2 min-w-[140px] rounded-xl`}
          >
            <ul className="list-none flex flex-col justify-end items-start gap-8">
              {navLinks.map((link) => (
                <li
                  key={link.id}
                  className={` ${
